...
export class Client {
   ...
   */
  constructor(service: Service, options: object, getSignHeader: Function);
  ...
  ): Promise<false | listDirResponse | any>;
  ...
  putFile(
    remotePath: string,
    localFile: string | stream.Stream | Buffer | buffer.File | Blob,
